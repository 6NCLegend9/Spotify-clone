...
test("official master audio and official videos outrank covers and lyric uploads", () => {
  ...
  assert.deepEqual(rankOfficialMusicResults([cover, topic, vevo], query), [topic, vevo]);
