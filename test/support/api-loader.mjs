...
const mocks = {
  ...
  "@/utils/rateLimit": "export const isRateLimited = async (...args) => globalThis.__apiFixtures.rateLimit?.(...args) || ({ limited: false }); export const getClientKey = () => 'fixture';",
  "@/utils/mailSender": "export default async function mailSender(...args) { return globalThis.__apiFixtures.mail(...args); }",
