    ...
    <div className="page animate-fade-in relative z-10">
      <header className="page-hero">
        <div>
          ...
          <h2 className="mt-3 flex items-center gap-2 overflow-visible text-3xl font-extrabold leading-tight sm:text-4xl lg:text-5xl">
            <GradientText
            ...
            <GiMusicalNotes aria-hidden="true" className="text-[#00e6e6]" />
          </h2>
